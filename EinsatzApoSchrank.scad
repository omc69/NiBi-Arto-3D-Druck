...
// --- Parameter (anpassbar) ---
laenge          =  320;  // Länge der Grundplatte in mm
breite          =  163;  // Breite der Grundplatte in mm
stuetzen_hoehe  =   15;  // Höhe der Eckstützen in mm
bohrung_dm      =   50;  // Innendurchmesser der Zylinder (= Öffnung) in mm
n_bohrungen     =    5;  // Anzahl Bohrungen pro Reihe entlang der Länge
zylinder_tiefe  =   22;  // Tiefe der Zylinder in mm (max = stuetzen_hoehe!)
...
randabstand     =  18;   // Mindestabstand Bohrungsrand → Plattenrand in mm
